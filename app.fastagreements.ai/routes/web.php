...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    Route::post('profile/logo', [ProfileController::class, 'updateLogo'])->name('logo.update');
...
// Route::get('/admin/deal-history/{id}', [DealHistoryController::class, 'showDealHistory'])->name('admin.deal-history');
    ...
    // User Management
    Route::post('admins/list', [UserController::class, 'index'])->name('users.data');
    ...
    */
    ...
    // Agreement Designer (Standalone CKEditor & PDF Preview)
    Route::get('agreement-designer', [\App\Http\Controllers\Admin\AgreementDocumentBuilderController::class, 'index'])->name('agreement-designer.index');
    Route::post('agreement-designer/preview', [\App\Http\Controllers\Admin\AgreementDocumentBuilderController::class, 'previewPdf'])->name('agreement-designer.preview');
