                ...
                <div class="col-lg-9">
                    <div class="card p-2 pt-4">
                        <div class="card-body">
                            ...
                            <form id="dealForm" action="{{ route('template.update')}}" method="post"
                                    ...
                                    <div class="custom-dropdown">
                                        <div class="custom-dropdown-trigger">
                                            <input type="text" class="form-control dropdown-search"
                                                ...
                                                value="{{ $template->dealCategory->category_name }}" />
                                            <input type="hidden" name="category_id" id="category_id"
                                                class="custom-dropdown-select" value="{{ $template->category_id }}" />
                                        </div>
                                        <div class="custom-dropdown-menu" style="display:none">
                                            <ul class="dropdown-options">
                                                <li data-value="">Select Category</li>
                                                @foreach ($dealCategories as $category)
                                                    <li data-value="{{ $category->id }}" {{ $template->category_id == $category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="custom-dropdown">
                                        <div class="custom-dropdown-trigger">
                                            <input type="text" class="form-control dropdown-search"
                                                ...
                                                value="{{ $template->languages->language_name }}" />
                                            <input type="hidden" name="language_id" id="language_id"
                                                class="custom-dropdown-select" value="{{ $template->language_id }}" />
                                        </div>
                                        <div class="custom-dropdown-menu_2" style="display:none">
                                            <ul class="dropdown-options">
                                                <li data-value="">Select Language</li>
                                                @foreach ($languages as $language)
                                                    <li data-value="{{ $language->id }}" {{ $template->language_id == $language->id ? 'selected' : '' }}>
                                ...
                                <div class="container py-3">
                                    ...
                                    <textarea class="form-control" id="editor" name="description"
                                        ...
                                        rows="19">{{ old('agreement_text', $template->agreement_text) }}</textarea>
                                </div>
