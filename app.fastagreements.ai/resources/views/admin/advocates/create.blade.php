...
<main id="main" class="main">
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-6 pt-2">
            <h1 class="fw-bold text-dark mb-1" style="font-size: 28px;">Create Advocate</h1>
            <p class="text-muted mb-0" style="font-size: 14px;">Fill the details below to add a new advocate profile.</p>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm" style="border-radius: 10px;">
                    <div class="card-body p-4 pb-0">
                        <form action="{{ route('advocates.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Enter advocate's full name" required>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('lawyer_type') is-invalid @enderror" id="lawyer_type" name="lawyer_type" value="{{ old('lawyer_type') }}" placeholder="e.g. Criminal Lawyer, Civil Advocate" required>
                                    @error('lawyer_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" placeholder="Enter price" required>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('consultation_time') is-invalid @enderror" id="consultation_time" name="consultation_time" value="{{ old('consultation_time') }}" placeholder="e.g. 30 minutes, 1 hour" required>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('experience') is-invalid @enderror" id="experience" name="experience" value="{{ old('experience') }}" placeholder="e.g. 5 Years, 10+ Years" required>
                                    @error('experience')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number" name="mobile_number" value="{{ old('mobile_number') }}" placeholder="Enter contact number" required>
                                    @error('mobile_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <textarea class="form-control @error('about') is-invalid @enderror" id="about" name="about" placeholder="Tell us about the advocate's background and achievements..." required>{{ old('about') }}</textarea>
                                    @error('about')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="Enter complete office address..." required>{{ old('address') }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        @foreach(['English', 'Hindi', 'Gujarati', 'Marathi', 'Tamil', 'Telugu'] as $lang)
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="languages_known[]" id="lang_{{ $lang }}" value="{{ $lang }}" {{ is_array(old('languages_known')) && in_array($lang, old('languages_known')) ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-box-container p-3 border rounded bg-light">
                                    <div class="row row-cols-2 row-cols-md-4 g-2">
                                        @foreach(['Criminal Case', 'Family Case', 'Civil Case', 'Property Case', 'Divorce', 'Labour Law', 'Consumer Court', 'GST', 'Company Law', 'Banking', 'Insurance'] as $exp)
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="expertise[]" id="exp_{{ Str::slug($exp) }}" value="{{ $exp }}" {{ is_array(old('expertise')) && in_array($exp, old('expertise')) ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-box-container p-3 border rounded bg-light">
                                    <div class="row row-cols-2 row-cols-md-4 g-2">
                                        @foreach(['B.Com', 'LL.B', 'LL.M', 'B.A. LL.B', 'BBA LL.B', 'M.Com', 'PhD Law'] as $deg)
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="degree[]" id="deg_{{ Str::slug($deg) }}" value="{{ $deg }}" {{ is_array(old('degree')) && in_array($deg, old('degree')) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="upload-box text-center p-4 border border-2 rounded position-relative">
                                        ...
                                        <label for="image" class="form-label fw-semibold text-primary cursor-pointer mb-1 d-block">Choose Profile Image</label>
                                        ...
                                        <div id="imagePreviewContainer" class="mt-3 d-none">
                                            <img id="imagePreview" src="#" class="img-thumbnail rounded shadow-sm" style="max-height: 150px; object-fit: cover;">
                                        </div>
                                    </div>
                                    @error('image')
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="upload-box text-center p-4 border border-2 rounded position-relative">
                                        ...
                                        <label for="video" class="form-label fw-semibold text-danger cursor-pointer mb-1 d-block">Choose MP4 Video</label>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="upload-box text-center p-4 border border-2 rounded position-relative">
                                        ...
                                        <label for="document" class="form-label fw-semibold text-info cursor-pointer mb-1 d-block">Choose Certificate</label>
                                        ...
                                        <div id="documentNameContainer" class="mt-3 d-none">
                                            <span class="badge bg-secondary p-2 rounded"><i class="bi bi-file-earmark-check-fill me-1"></i><span id="documentName">filename.pdf</span></span>
                                        </div>
                                    </div>
                                    @error('document')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    <label for="total_reviews" class="form-label fw-bold" style="color: #495057;">Initial Total Reviews</label>
                                    <input type="number" class="form-control @error('total_reviews') is-invalid @enderror" id="total_reviews" name="total_reviews" value="{{ old('total_reviews', 0) }}">
                                    @error('total_reviews')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-actions-footer text-end">
                                <button type="submit" class="btn btn-success px-5 py-2.5 me-2 shadow-sm" style="background-color: #198754; border-color: #198754; border-radius: 8px; font-weight: 600;">
                                    <i class="bi bi-save-fill me-2"></i>Save Advocate
                                </button>
