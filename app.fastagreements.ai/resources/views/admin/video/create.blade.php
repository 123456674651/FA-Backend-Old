    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Upload New Video</h5>
                        
                        <!-- General Form Elements -->
                        <form action="{{ route('videos.store') }}" id="videoForm" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="title" type="text" name="title" placeholder="Enter Video Title" >
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="tags" type="text" name="tags" placeholder="Enter Tags (comma separated)" >
                                </div>
                            </div>

                            <div class="row mb-3">
                                <div class="col-sm-10 offset-sm-2">
                                    <button type="submit" class="btn button-color text-white">Upload Video</button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            videoForm.addEventListener('submit', function (event) {
                ...
                } else if (!['video/mp4', 'video/avi', 'video/mkv'].includes(videoFile.type)) {
