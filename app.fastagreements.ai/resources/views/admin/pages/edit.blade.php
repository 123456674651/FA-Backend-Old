                    ...
                    <div class="card-body">
                        <form action="{{ route('pages.update', $page->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('page_title') is-invalid @enderror" id="page_title" name="page_title" value="{{ old('page_title', $page->page_title) }}" required>
                                @error('page_title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('page_slug') is-invalid @enderror" id="page_slug" name="page_slug" value="{{ old('page_slug', $page->page_slug) }}" readonly>
                                @error('page_slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('page_details') is-invalid @enderror" id="page_details" name="page_details" value="{{ old('page_details', $page->page_details) }}" required>
                                @error('page_details')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
<textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror">{!! old('description', $page->description) !!}</textarea>
