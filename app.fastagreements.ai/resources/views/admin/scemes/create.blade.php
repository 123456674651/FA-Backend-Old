    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Create New Scheme</h5>
                        
                        <!-- General Form Elements -->
                        <form action="{{ route('scemes.store') }}" method="post">
                            @csrf
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input class="form-control" id="emi_pay_method" type="text" name="emi_pay_method" placeholder="Enter EMI Pay Method" required></td>
                                    </tr>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('scemes.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="emi_pay_method" type="text" name="emi_pay_method" placeholder="Enter EMI Pay Method" required>
                            </div>
