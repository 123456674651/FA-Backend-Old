                        ...
                        <form action="{{ route('cms-pages.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="file" class="form-control @error('featured_image') is-invalid @enderror" id="featured_image" name="featured_image" accept="image/*" onchange="displaySelectedImage(event, 'featured_image_preview'); document.getElementById('featured_image_preview').style.display='block';">
                                    @error('featured_image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <img id="featured_image_preview" src="" alt="Featured Image Preview" style="max-height: 150px; display: none;" class="img-thumbnail mt-2">
                                </div>
                            ...
                            <div class="text-end mt-4">
                                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Save Page</button>
