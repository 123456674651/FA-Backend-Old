      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <img src="{{ s3_asset_or($user->profile_picture, asset('assets/img/profile-img.jpg')) }}" alt="Profile" class="rounded-circle" style="width: 120px; height: 120px; object-fit: cover; border: 2px solid #ddd;">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <div class="d-flex align-items-center gap-3">
                      <img id="avatar-preview" src="{{ s3_asset_or($user->profile_picture, asset('assets/img/profile-img.jpg')) }}" alt="Profile" class="rounded-circle" style="width: 90px; height: 90px; object-fit: cover; border: 1px solid #ccc;">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <div class="bg-dark p-3 rounded d-inline-block border">
                        <img id="logo-preview" src="{{ s3_asset_or('assets/img/logo/dashboard_logo.png', asset('assets/img/logo/dashboard_logo.png')) }}?v={{ time() }}" alt="Current Logo" style="max-height: 80px; width: auto; object-fit: contain;">
                      </div>
                    </div>
                  </div>
