...
<main id="main" class="main">
    <div class="row">
        <div class="pagetitle col-lg-6 pt-2">
            <h1>Create Legal Notice</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('legal-notices.index') }}">Legal Notices</a></li>
                    <li class="breadcrumb-item active">Create Legal Notice</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{ route('legal-notices.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('company_person_name') is-invalid @enderror" id="company_person_name" name="company_person_name" value="{{ old('company_person_name') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('company_person_designation') is-invalid @enderror" id="company_person_designation" name="company_person_designation" value="{{ old('company_person_designation') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('my_company_name') is-invalid @enderror" id="my_company_name" name="my_company_name" value="{{ old('my_company_name') }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('my_company_business_nature') is-invalid @enderror" id="my_company_business_nature" name="my_company_business_nature" value="{{ old('my_company_business_nature') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('amount_due') is-invalid @enderror" id="amount_due" name="amount_due" value="{{ old('amount_due') }}" required>
                                    @error('amount_due')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="text-end mt-4">
                                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Save Notice</button>
