...
<main id="main" class="main">
    ...
    <div class="row">
        <div class="pagetitle col-lg-6 pt-2">
            <h1>Add Deal Category</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('') }}">Home</a></li>
                    <li class="breadcrumb-item">Deal Category</li>
                    <li class="breadcrumb-item active">Add Deal Category</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('deal_categories.store') }}" id="contactForm" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="mb-4 d-flex justify-content-centerx">
                                        <img id="selectedImage" src="{{ asset('assets/img/logo/logo.jpeg') }}" alt="category image" style="width: 100px;" />
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="deal_price" type="number" step="0.01" name="deal_price" placeholder="Enter Deal Price" >
                                </div>
                            </div>
