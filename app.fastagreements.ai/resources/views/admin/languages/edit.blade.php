                        ...
                        <form action="{{ route('languages.update', $language->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('language_name') is-invalid @enderror"
                                    id="language_name" name="language_name"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('language_code') is-invalid @enderror"
                                    ...
                                    value="{{ old('language_code', $language->language_code) }}" required>
                                @error('language_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('language_in_guj') is-invalid @enderror"
                                    id="language_in_guj" name="language_in_guj"
                                    value="{{ old('language_in_guj', $language->language_in_guj) }}" required>
