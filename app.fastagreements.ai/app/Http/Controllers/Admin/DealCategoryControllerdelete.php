         ...
         if ($request->ajax()) {
             ...
             return Datatables::of($dealCategories)
                 ...
                 ->addColumn('status', function ($dealCategory) {
                    ...
                    $buttonClass = $dealCategory->is_active ? 'outline-success' : 'outline-danger';
                 ...
                 ->addColumn('action', function ($dealCategory) {
                     ...
                     return '<div class="text-center">
                                 <a href="' . $editUrl . '" class="edit btn btn-primary btn-sm">
                                   ...
                                   <a href="' . $attributeUrl . '" class="edit btn btn-warning btn-sm">
                                     <i class="bi bi-at"></i>
                                 </a>
                                 <a data-bs-toggle="modal" href="#delete_modal_' . $dealCategory->id . '" class="btn btn-danger btn-sm" title="Delete">
                                     <i class="bi bi-trash"></i>
                                 </a>
                                  <a href="' . $manageAttributesUrl . '" class="edit btn btn-info btn-sm text-white">
                  ...
                  ->addColumn('template', function ($dealCategory) {
                    $duplicateUrl = route('template', $dealCategory->id);

                    // Example of a column with a delete button, adjust based on need
                    return '<div class="text-center">
                       

                         <a href="' . $duplicateUrl . '" data-bs-toggle="modalx"   class="btn btn-success btn-sm" title="Template">
                 ...
                 ->rawColumns(['logo', 'action', 'status','template'])
                 ->make(true);
         }
     
         return view('admin.deal_categories.index');
     }
