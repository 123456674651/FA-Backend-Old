...
class PhpWordController extends Controller
{
	 ...
	 * }
	 */
	protected function buildTemplateValues(Aggriment $aggriment): array
	{
	 ...
	 */
	protected function rebuildInstallments(Aggriment $aggriment): void
	{
	...
	public function convertWordToPdf(Request $request)
	{
		...
		try {
			...
			$process = new Process([
				...
				'--nofirststartwizard',
				'--convert-to',
				'pdf:writer_pdf_Export:PaperSize=A4',
				'--outdir',
				$outputDir,
				$inputPath,
			]);
